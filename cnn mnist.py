...
class cnn:
    ...
    def build(self,output_dim):
        ...
        #input_shape=(28, 28)
        hidden_layer1=Conv2D(32, (3, 3), activation='relu')(input)
        ...
        hidden_layer3=Conv2D(64, (3, 3), activation='relu')(hidden_layer2)
        hidden_layer4=MaxPooling2D((2, 2))(hidden_layer3)
        hidden_layer5=Conv2D(64, (3, 3), activation='relu')(hidden_layer4)
...
Cnn_Model.summary()
#trong summary cua model thi output shape là hinh dang cua cac feature map dau ra